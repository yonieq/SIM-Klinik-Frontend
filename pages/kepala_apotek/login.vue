            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                  <img src="../../static/sri.jpeg" alt="Vue Material Admin" width="120" height="120">
                  <h3 class="flex my-4 primary--text">SRI KLINIK | KEPALA APOTEK</h3>
                </div>
                <v-form>
  ...
  export default {
    ...
    methods: {
      login() {
        this.loading = true;
        setTimeout(() => {
          this.$router.push('/kepala_apotek/dashboard');
        }, 1000);
      }
    }
