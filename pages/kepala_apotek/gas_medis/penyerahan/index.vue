<template>
  <div id="page-statistic">
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        <v-flex sm12>
          <h3>Data Penyerahan Gas Medis Ke Supplier</h3>
        </v-flex>
        <v-flex sm12>
          <a href="/kepala_apotek/gas_medis/penyerahan/tambah">
...
import { Items as Penerimaan } from "@/api/kepala_apotek/gas_medis/penerimaan";
export default {
