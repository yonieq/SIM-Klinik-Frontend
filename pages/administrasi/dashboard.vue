      ...
      <v-layout row wrap>
        <v-flex lg4 sm6 xs12>
          <mini-statistic
            icon="people_alt"
            title="1+"
            sub-title="Permintaan Surat Rujukan"
        ...
        <v-flex lg4 sm6 xs12>
          <mini-statistic
            icon="people_alt"
            title="1"
            sub-title="Pasien Mendapat Rujukan"
            color="red darken-2"
          >
          </mini-statistic>
        </v-flex>
                ...
                <template slot="items" slot-scope="props">
                  ...
                  <td>
                    ...
                    <v-btn
                      ...
                      small
                      round
                      to="/administrasi/rujukan/proses"
                      >Proses</v-btn
                    >
                  </td>
                </template>
...
import {Items as Users} from '@/api/administrasi/rujukan//data';
