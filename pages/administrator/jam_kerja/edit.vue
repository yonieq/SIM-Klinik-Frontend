            ...
            <v-flex sm4 lg4>
              ...
              >
                <v-text-field
                  ...
                  required
                ></v-text-field>
                <v-time-picker v-model="form.masuk">
                  <v-spacer></v-spacer>
            ...
            <v-flex sm4 lg4>
              ...
              >
                <v-text-field
                  slot="activator"
                  label="Keterlambatan"
                  v-model="form.terlambat"
                  append-icon="access_time"
                  readonly
                  required
                ></v-text-field>
                <v-time-picker v-model="form.terlambat">
                  <v-spacer></v-spacer>
            ...
            <v-flex sm4 lg4>
              ...
              >
                <v-text-field
                  ...
                  required
                ></v-text-field>
                <v-time-picker v-model="form.pulang">
                  <v-spacer></v-spacer>
