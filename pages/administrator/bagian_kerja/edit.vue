<template>
  <v-container grid-list-xl fluid>
    ...
    <v-card>
      <v-toolbar card>
        <h3>Edit Data Bagian Kerja & Gaji</h3>
      </v-toolbar>
      <v-card-text>
          ...
          <v-layout row wrap>
            <v-flex lg12 sm12>
              <v-text-field
                ...
                placeholder="Masukan nama bagian kerja"
                required
              >
              </v-text-field>
            </v-flex>
            <v-flex lg6 sm6>
              <v-text-field
                ...
                type="number"
                prefix="Rp."
                v-model="form.perhari"
                placeholder="Gaji untuk satu hari"
              >
              </v-text-field>
            </v-flex>
            <v-flex lg6 sm6>
              <v-text-field
                ...
                prefix="Rp."
                v-model="form.cuti"
                placeholder="Upah cuti untuk satu hari"
              >
              </v-text-field>
            </v-flex>
            <v-flex lg6 sm6>
              <v-text-field
                label="Upah Izin Ruangan"
                name="izin"
                type="number"
                prefix="Rp."
                v-model="form.izin"
                placeholder="Upah izin untuk satu hari"
              >
              </v-text-field>
            </v-flex>
            <v-flex lg6 sm6>
              <v-text-field
                ...
                prefix="Rp."
                v-model="form.lembur"
                placeholder="Upah lembur untuk satu jam"
              >
              </v-text-field>
            </v-flex>
            <v-spacer></v-spacer>
