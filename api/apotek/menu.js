const Menu = [
    ...
    },
    {
      ...
      items: [
            {name: 'luar', group: 'permintaan',title: 'Penjualan Luar Klinik', href: '/apotek/penjualan'},
            {name: 'dalam',group: 'penjualan', title: 'Penebusan Obat Pasien', href: '/apotek/permintaan'},
          ]
    },
    {
      title: 'Retur Barang',
